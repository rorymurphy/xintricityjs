(function(e,d){"function"===typeof define&&define.amd?define("XUtil",["jQuery","_"],function(g,c){return e.XUtil=d(b)}):e.$x=e.XUtil=d(e.jQuery,e._)})(this,function(e,d){var g=window,c;"undefined"!==typeof m&&(c=m);var m={namespace:function(d){d=d.split(".");var c;e.each(d,function(d,f){0==d&&(c=g);f in c||(c[f]={});c=c[f]});return c},format:function(d){var c=arguments;return d=d.replace(/\{(\d+)\}/ig,function(d,f,s,a){return c[parseInt(f)+1]})}},p=/\/[^w_]+\//;m.slugify=function(d){return d.replace(p,
"-").toLowerCase()};m.extend=function(c){d.each(Array.prototype.slice.call(arguments,1),function(d){if(d)for(var k in d){var f=d.__lookupGetter__(k),s=d.__lookupSetter__(k);f||s?(f&&c.__defineGetter__(k,f),s&&c.__defineSetter__(k,s)):c[k]=d[k]}});return c};m.noConflict=function(){c?window.$x=c:delete window.$x};return m});
(function(e,d){"function"===typeof define&&define.amd?define("XTemplate",["jQuery","underscore","XUtil"],function(e,c,m){return m.template=d(e,c,m)}):$x.template=d(e.jQuery,e._,e.XUtil)})(this,function(e,d,g){g=function(){d.bindAll(this,"initialize","addTemplate")};g.prototype={_templates:{},_templateTypes:{},initialize:function(){},getTemplate:function(e){c();d.has(this._templates,e)||this.addTemplate(e);return this._templates[e]},addTemplate:function(g,m,r){c();if(void 0===r||null===r){var k=e("#"+
g);if(0==k.length)throw"Must specify a name that corresponds to a template element or provide the template text";k.is('script[type^="text/template"]');r=k.html();void 0===m&&(m=k.data("xt-template"),void 0===m&&(k=k.attr("type"),k=/^text\/template-(.+)$/.exec(k),1<k.length&&(m=k[1])))}if(!d.has(this._templateTypes,m))throw"Unrecognized template type";m=this._templateTypes[m](r);this._templates[g]=m},registerTemplateType:function(d,c){this._templateTypes[d]=c}};var c=function(){d.has(this._templateTypes,
...
(function(e,d){"function"===typeof define&&define.amd?define("XMVVM-Model",["jQuery","underscore","XUtil"],function(g,c,m){return e.XMVVM=d(g,c,m)}):e.XMVVM=d($,_,$x)})(this,function(e,d,g){var c={};Backbone.Model.isParentTypeOf=function(d){return Backbone.Model.prototype.isPrototypeOf(d.prototype)};Backbone.Collection.isParentTypeOf=function(d){return Backbone.Collection.prototype.isPrototypeOf(d.prototype)};var m=g.extendClass=function(k,f){var c=this,a;a=k&&d.has(k,"constructor")?k.constructor:
function(){return c.apply(this,arguments)};g.extend(a,c,f);var n=function(){this.constructor=a};n.prototype=c.prototype;a.prototype=new n;k&&g.extend(a.prototype,k);a.__super__=c.prototype;return a},p=function(k,f){this.fields||(this.fields={});this.fields&&!d.has(this,"fields")&&(this.fields=g.extend({},this.fields));d.isFunction(f)&&(f={type:f},this.fields[k]=f);d.has(this.fields,k)||(this.fields[k]=f);this.fields[k].name=k;this[k]=function(){if(1===arguments.length)this.set(k,arguments[0]);else return this.get(k)}};
d.mixin({resultBB:function(k,f,c){void 0===c&&(c=!0);var a=k[f];void 0===a&&k instanceof Backbone.Model&&(a=k.get(f));void 0!==a&&c&&d.isFunction(a)&&(a=a());return a},startsWith:function(d,f){return d.substr(0,f.length)===f},endsWith:function(d,f){var c=d.length-f.length;return 0<=c&&d.substr(c)===f}});var u=0;c.Event=function(d){this.eid="e"+u;u++;g.extend(this,d)};c.Event.extend=m;c.Model=Backbone.Model.extend({constructor:function(k,f){var c=this;d.bindAll(this,"createField","set");d.defaults(c,
{fields:{}});d.chain(c.fields).keys().each(function(a){c[a]=d.bind(c[a],c)});Backbone.Model.apply(this,[k,f])},fields:{},createField:function(k,c){p.call(this,k,c);this[k]=d.bind(this[k],this)},clone:function(){var k=new this.constructor(this.attributes);d.chain(k.fields).keys().each(function(c){k[c]=d.bind(k[c],k)});k.fields=g.extend({},this.fields);d.each(k.fields,function(d,c,a){k.constructor.prototype&&k.constructor.prototype.fields&&k.constructor.prototype.fields[c]||k.createField(c,d)});return k},
trigger:function(d){var f=Array.prototype.slice.call(arguments),e;if(1<arguments.length&&!(arguments[1]instanceof c.Event)){var f=d,a=d.indexOf(":");-1!==a&&(f=d.substr(0,a+1));switch(f){case "add":case "remove":case "destroy":e=new c.Event({model:arguments[1],collection:arguments[2],options:arguments[3]});break;case "reset":case "sort":e=new c.Event({collection:arguments[1],options:arguments[2]});break;case "change":e=new c.Event({model:arguments[1],options:arguments[2]});break;case "request":case "error":e=
new c.Event({model:arguments[1],xhr:arguments[2],options:arguments[3]});break;case "sync":e=new c.Event({model:arguments[1],resp:arguments[2],options:arguments[3]});break;case "invalid":e=new c.Event({model:arguments[1],error:arguments[2],options:arguments[3]});break;case "route":e=new c.Event({params:arguments[1]});break;case "change:":e=new c.Event({model:arguments[1],value:arguments[2],options:arguments[3]});break;case "route:":e=new c.Event({route1:arguments[1],route2:arguments[2],params:arguments[3]})}null!==
e?Backbone.Model.prototype.trigger.apply(this,[d,e]):Backbone.Model.prototype.trigger.apply(this,arguments)}else 1===arguments.length?(this instanceof c.Model?e=new c.Event({model:this}):this instanceof c.Collection&&(e=new c.Event({collection:this})),f.push(e),Backbone.Model.prototype.trigger.apply(this,f)):Backbone.Model.prototype.trigger.apply(this,arguments)},set:function(c,f,e){var a=this,n,l,h=a.fields;d.isObject(c)?(n=c,e=f):(n={})[c]=f;d.each(n,function(n,c,k){var e;if(null!==h&&d.has(h,c)&&
(k=h[c],f=a._prepareValue(k,n),e=!0,d.isFunction(k.validate)&&(e=k.validate(n)),!0!==e))throw e;l=a[c];null!==l&&(l instanceof Backbone.Model||l instanceof Backbone.Collection)&&l.off("all",g,this);if(n instanceof Backbone.Model||n instanceof Backbone.Collection){var g=function(n,l){var c=Array.prototype.slice.call(arguments);d.has(l,"model")&&l.model===a||d.has(l,"recipients")&&d.has(l.recipients,a.cid)||(l.recipients=l.recipients||{},l.recipients[a.cid]=!0,a.trigger.apply(a,c))};(k=a.get(c))&&k.off("all",
g,a.cid+c);n.on("all",g,a.cid+c)}});Backbone.Model.prototype.set.apply(this,[n,e])},_prepareValue:function(c,f){if(void 0===f||null===f)return f;switch(c.type){case "int":"int"!==typeof f&&(f=parseInt(f));break;case Number:d.isNumber(f)||(f=parseFloat(f));break;case Boolean:d.isBoolean(f)||(f=!0==f);break;case String:d.isString(f)||(f+="");break;case Date:f instanceof Date||(d.isNumber(f)?f=new Date(f):d.isString(f)&&(f=Date.parse(f)));break;case Array:if(!(f instanceof Array))throw"Type mismatch";
break;default:if(!(f instanceof c.type))if((c.type===Backbone.Model||Backbone.Model.isParentTypeOf(c.type))&&d.isObject(f)||(c.type===Backbone.Collection||Backbone.Collection.isParentTypeOf(c.type))&&(d.isObject(f)||d.isArray(f)))f=new c.type(f);else if(!(f instanceof c.type))throw"Type mismatch";}return f},parse:function(c){d.each(this.fields,function(d,e,a){if(Backbone.Model.isParentTypeOf(d.type)||Backbone.Collection.isParentTypeOf(d.type))c[d.name]=new d.type(c[d.name],{parse:!0})});return c}});
c.Model.extend=function(c,f){var e=m.call(this,c,f);this.prototype.fields&&d.each(this.prototype.fields,function(a,d){p.call(e.prototype,d,a)});d.has(c,"fields")&&d.each(c.fields,function(a,d){p.call(e.prototype,d,a)});return e};c.Model.defaults={useGetSet:!1};c.Collection=Backbone.Collection.extend({unique:function(){var c=array.slice.call(arguments);c.unshift(this.models);return d.unique.apply(d,c)},_onModelEvent:function(d,c,e,a){"add"!==d&&"remove"!==d||e===this?Backbone.Collection.prototype._onModelEvent.apply(this,
arguments):this.trigger.apply(this,arguments)}});c.View=Backbone.View.extend({});c.ViewModel=c.Model.extend({view:null,fields:{model:Object},render:function(){if(this.view)return g.template(this.view)(this.model(),{context:{viewmodel:this}})}});var r=function(d,c){if(1==arguments.length)return this.get(d);this.set(d,c)};c.ModelNavMixins={splitModelPath:function(d){return d.match(/\w+(?=\.?)|(?=\[)\w+(?=\])/g)},resolveModelPath:function(d,c,e){return this.resolveModelExpression(d,{path:c},e)},resolveModelExpression:function(c,
e,g){var a=e.path;if(3>arguments.length||void 0===g)g={};g=d.defaults(g,{evalVal:!0,allowPartial:!0});var n=[c];if("undefined"!==typeof a&&null!==a&&""!==a){for(var a=a instanceof Array?a:this.splitModelPath(a),l=0;l<a.length;l++){var h=n[n.length-1];if(null==h&&g.allowPartial)break;else if(null==h){n=void 0;break}h=h instanceof Backbone.Collection?h.at(a[l]):!h[a[l]]&&h instanceof Backbone.Model&&h.has(a[l])?d.bind(r,h,a[l]):l<a.length-1||g.evalVal?d.resultBB(h,a[l]):h[a[l]];if("undefined"===typeof h){g.allowPartial||
(n=void 0);break}n.push(h)}a=void 0!==n&&null!==n&&0<n.length?d.last(n):n;l=this._applyBindExpression(e,a,c);l!==a&&n.push(l);return n}},resolveModelExpressionValue:function(c,e){var g=this.resolveModelExpression(c,e,{allowPartial:!1});return g=void 0!==g&&d.isArray(g)&&0<g.length?d.last(g):void 0},_applyBindExpression:function(c,e,m){if(d.has(c,"filter")&&d.isString(c.filter)){c=this.resolveModelPath(m,c.filter,{evalVal:!1,allowPartial:!1});if(d.isArray(c))c=d.last(c);else throw"Invalid filter, path does not exist";
if(d.isFunction(c))e=c(e);else throw"Invalid filter, not a function";}else d.has(c,"pattern")&&d.isString(c.pattern)&&(e=g.format(c.Pattern,e));return e},bindModelPath:function(d,c,e,a){this.bindModelExpression(d,{path:c},e,a)},bindModelExpression:function(e,f,g,a){var n=this.splitModelPath(f.path),l=this.resolveModelPath(e,n),h={model:e,expression:f,callback:g},x=function(a){var c=d.indexOf(l,a.model);return 0>c||c==n.length||0!==c&&!d.has(a.model.changed,n[c])?!1:!0};d.has(this,"_bindingCallbacks")||
(this._bindingCallbacks=[]);h.checkCallback=d.bind(function(a,f){var q;q=!1;switch(a){case "change":q=Array.prototype.slice.call(arguments,1,arguments.length);q=x.apply(this,q);break;case "add":case "remove":q=d.indexOf(l,f.collection),q=0<=q&&(q===l.length-1||d.indexOf(l,f.collection)===q+1)}if(q=q&&!((this instanceof Backbone.Model||this instanceof Backbone.Collection)&&d.has(f,"recipients")&&d.has(f.recipients,this.cid))){l=this.resolveModelPath(e,n);f.recipients=d.has(f,"recipients")?f.recipients:
{};f.recipients[this.cid]=!0;g.apply(this,arguments);q=new c.Event;q.oldValue=h.value;var m=this.resolveModelExpression(h.model,h.expression),m=this._applyBindExpression(h.expression,m,h.model),m=m.length===n.length+1?d.last(l):void 0;q.value=m;h.value=m;g.apply(this,[q])}},this);this._bindingCallbacks.push(h);e.on("all",h.checkCallback,this)},unbindModelPath:function(d,c,e){this.unbindModelExpression(d,{path:c},e)},unbindModelExpression:function(c,e,g){var a=d.find(this._bindingCallbacks,function(a){return a.model===
c&&d.isEqual(a.expression,e)&&a.callback===g});c.off("all",a.checkCallback,this)},setModelPathValue:function(c,e,g,a){a=void 0===a?!0:a;e=d.isArray(e)?e:this.splitModelPath(e);c=this.resolveModelPath(c,e,{evalVal:!1,allowPartial:!1});var n=c.length,l=c[n-1];a&&d.isFunction(l)?l(g):l instanceof Backbone.Collection?c[n-2].update(g):c[n-2][e[n-1]]=g}};return c});
...
setModelAttr:function(a){var c=this._modelPath;if(void 0===c||null===c)throw"Xintricity cannot set model value, expression does not exist: "+this.options.expression.path;var l=c.length,h=this.splitModelPath(this.options.expression.path);if(0<l&&d.isFunction(c[l-1]))c[l-1](a);else c[l-2][d.last(h)]=a},modelChanged:function(a,d,c){this._modelPath=this.resolveModelExpression(this.options.model,this.options.expression,{evalVal:!1,allowPartial:!1});this.options.updateElement&&this.setElProp(this.value())},
...
a,{evalVal:!0,allowPartial:!1});return d.isArray(a)&&0<a.length?d.last(a):void 0},modelChanged:function(a){this.updateText()},updateText:function(){var a=this,c=[a.options.pattern],l=!1;d.each(a.options.paths,function(h){d.has(h,"html")&&"true"===h.html?(c.push(a.value(h)),l=!0):(h=(h=a.value(h))?a.escapeHtml(h):h,c.push(h))});var h=g.format.apply(this,c).replace(/&#123;/,"{").replace(/&#125;/,"}");if(l){var f=document.createElement("div"),v=e(a.options.el).parent().get(0),k=a.options.el;k instanceof
NodeList||(k=[a.options.el]);f.innerHTML="<div>"+h+"</div>";f=f.children;d.each(f,function(a){v.insertBefore(a,k[0])});d.each(k,function(a){v.removeChild(a)});0<e(f).parents("html").length&&e(f).filter("script").each(function(){e.globalEval(this.text||this.textContent||this.innerHTML||"")});a.options.el=f}else a.options.el.nodeValue=h},escapeHtml:function(a){return a.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},dispose:function(){var a=this;d.each(this.options.paths,
...
e(this.options.el)},unbindEl:function(){e(t.options.el).off("change.binding",t.elChanged);this._modelPath=null},createOptions:function(a){var c=this,l=e(c.options.el),h=l.val();l.empty();var f=function(a,h,f){h=d.resultBB(a,c.options.textField);a=d.resultBB(a,c.options.valueField);f=e(document.createElement("option"));f.text(h).val(a);l.append(f)};a instanceof Backbone.Collection?a.each(f):d.each(a,f);l.val(h)},dispose:function(){this.unbindModel();this.unbindEl()}});g.extend(c.SelectBinding.prototype,
...
"bind","unbind","dispose");this.bind()},defaults:{el:null,event:"click",target:null},onTrigger:function(){var a=this,c=e(a.options.el),l=c;null!=a.options.target&&(l=a.getTarget(c));null!=a.options.cssClass&&(a.options.cssClass instanceof Array?d.each(a.options.cssClass,function(a,d,c){l.addClass(a)}):l.addClass(a.options.cssClass));null!=a.options.styles&&(a.prevStyles={},d.each(a.options.styles,function(d,c,e){a.prevStyles[c]=l.css(c);l.css(c,d)}))},onTriggerInv:function(){var a=$el;null!=t.options.target&&
...
a.parseTextBindings(d)})},parseTriggers:function(){var a=this;a.$el.find("[data-xt-event]").not(a.excludeNestedScopes).each(function(f,l){var h=e(l),g=h.parent(),g={el:g,position:a.calculatePosition(g,a.$el)},k=h.data("xt-action"),w=h.data("xt-value"),q=h.data("xt-style"),p=h.data("xt-class");if(k)g.type=c.ActionTrigger,g.action=a.parseBinding(k,!1),void 0!==w&&(g.value=a.parseBinding(w,!1)),g.event=h.data("xt-event");else if(null!=q||null!=p)g.type=c.StyleTrigger,g.styles={},null!=q&&(q=h.data("xt-style").split(";"),
d.each(g.styles,function(a){a=a.split(":");option.styles[a[0].trim()]=a[1].trim()})),null!=p&&(g.cssClass=p);h.remove();a._triggers.push(new m(g))})},parseForeaches:function(){var a=this;a.$el.find("[data-xt-foreach]").not(a.excludeNestedScopes).each(function(c,d){var h=e(d),f=new m({el:d,type:"foreach",position:a.calculatePosition(h,a.$el),expression:a.parseBinding(h.data("xt-foreach")),iterator:h.data("xt-iterator")});h.is("[data-xt-onrender]")&&(f.options.onrender=a.parseBinding(h.data("xt-onrender")));
a._logicBlocks.push(f)})},parseIfs:function(){var a=this;a.$el.find("[data-xt-if]").not(a.excludeNestedScopes).each(function(c,d){var h=e(d),f=h.next(),g=new m({el:d,type:"if",position:a.calculatePosition(h,a.$el),branches:[],defaultBranch:null}),k=new m({el:h,type:"branch",expression:a.parseBinding(h.data("xt-if"))});h.is("[data-xt-onrender]")&&(k.options.onrender=a.parseBinding(h.data("xt-onrender")));for(g.options.branches.push(k);f.is("[data-xt-elseif]");)k=new m({el:f,type:"branch",expression:a.parseBinding(h.data("xt-elseif"))}),
f.is("[data-xt-onrender]")&&(k.options.onrender=a.parseBinding(f.data("xt-onrender"))),g.options.branches.push(k),f=f.next();f.is("[data-xt-else]")&&(g.options.defaultBranch=new m({el:f,type:"else"}),f.is("[data-xt-onrender]")&&(g.options.defaultBranch.options.onrender=a.parseBinding(f.data("xt-onrender"))));a._logicBlocks.push(g)})},parseTemplates:function(){var a=this;a.$el.find("[data-xt-template]").not(a.excludeNestedScopes).each(function(c,d){var h=e(d);a._nestedTemplates.push(new m({el:d,type:"templateref",
position:a.calculatePosition(h,a.$el),template:h.data("xt-template"),model:a.parseBinding(h.data("xt-model"))}))})},parseAttributeBindings:function(a){var f=e(a),l=this;d.each(a.attributes,function(a){var e=a.name;"data-xt-"===e.substr(0,8)&&"data-xt-src"!==e||"id"===e||"type"===e||(a=a.value,a=l.parseBinding(a),d.isObject(a)&&l._bindings.push({expression:a,type:c.AttributeBinding,position:l.calculatePosition(f,l.$el),attr:e}))})},parseCssClassBindings:function(a){var f=e(a),l=this;a=d.filter(a.attributes,
function(a){return d.startsWith(a.name,"data-xt-class-")});d.each(a,function(a){var e=a.name;a=a.value;a=l.parseBinding(a);d.isObject(a)&&l._bindings.push({expression:a,type:c.CssClassBinding,position:l.calculatePosition(f,l.$el),cssClass:e.substr(14)})})},parseTextBindings:function(a){var f=this;a=e(a).contents();d.each(a.filter(function(){return 3==this.nodeType}),function(a){for(var h=[],g=null;g=m.textBindingPattern.exec(a.nodeValue);)h.push(g[0]);if(null!=h&&0<h.length){var k=d.uniq(h),h=d.map(k,
function(a){return f.parseBinding(a)}),g=a.nodeValue,g=g.replace(/\{/,"&#123;").replace(/\}/,"&#125;"),g=a.nodeValue.replace(m.textBindingPattern,function(a){return"{"+d.indexOf(k,a)+"}"});f._bindings.push({type:c.TextNodeBinding,paths:h,pattern:g,position:f.calculatePosition(e(a),f.$el)})}})},parseSelectBindings:function(a){var d=this,l;d.$el.find("select[data-xt-options]").not(d.excludeNestedScopes).each(function(a,f){var g=e(f);l=g.data("xt-options");var k={el:f,type:c.SelectBinding,path:l.substr(2,
l.length-4),position:d.calculatePosition(g,d.$el)},m=g.data("xt-text-field"),g=g.data("xt-value-field");void 0!==m&&null!==m&&(k.textField=m);void 0!==g&&null!==g&&(k.valueField=g);d._bindings.push(k)})},parseBinding:function(a,c){var d={},e,f=/^\{\{(?:\s*(Path|Filter|Pattern|HTML)\s*=\s*(?:'([^']*)'|"([^"]*)")\s*\,?)+\}\}$/ig,g=/(Path|Filter|Pattern|HTML)\s*=\s*('[^']*'|"[^"]*")\s*/ig;1===arguments.length&&(c=!0);e=a.match(/^\{\{([\w\.\[\]]+)\}\}$/i);if(null!==e&&1<e.length)d.path=e[1];else if(c)if(null!==
f.exec(a)){for(;e=g.exec(a);)d[e[1].toLowerCase()]=e[2].substring(1,e[2].length-1);d.hasOwnProperty("path")||(d=void 0)}else d=a;else d=a;return d},createInstance:function(a){if("template"!==this.options.type)throw"Invalid object type";return new u({block:this})},calculatePosition:function(a,d){a=e(a);d=e(d);var c=a.parentsUntil(d);if(0!==a.closest(d).length){var f=[a.parent().contents().index(a)];c.each(function(a,d){var c=e(d);f.unshift(c.parent().contents().index(c))});return f}}});var p=function(a){this.options=
g.extend({},a);0<arguments.length&&(d.defaults(this.options,this.defaults),a.el&&this.setEl(a.el));this.initialize()};p.extend=g.extendClass;g.extend(p.prototype,{defaults:{block:null,context:null,el:null},initialize:function(){this._bindings=[];this._triggers=[];this._logicBlocks=[];this._nestedTemplates=[];d.bindAll(this,"render")},render:function(){},renderInternal:function(a,c,l){var h=this;a=a?a:this.options.block;var m=e(c);d.each(a._triggers,function(a,d){var c=a.options.type,e=g.extend({},
a.options);e.el=h.resolveElement(m,a.options.position);e.context=l;delete e.type;delete e.position;h._triggers.push(new c(e))});d.each(a._logicBlocks,function(a,d){var c=h.resolveElement(m,a.options.position);switch(a.options.type){case "if":c=new k({block:a,context:l,el:c});break;case "foreach":c=new f({block:a,context:l,el:c});break;default:throw"Unknown logic block";}h._logicBlocks.push(c);c.render()});d.each(a._bindings,function(a,c){var d=h.resolveElement(m,a.position),d=g.extend({},a,{model:l,
el:d});delete d.position;d=new a.type(d);h._bindings.push(d)});d.each(a._nestedTemplates,function(a,d){var c=h.resolveElement(m,a.options.position),c=new r({block:a,context:l,el:c});h._nestedTemplates.push(c);c.render()})},setEl:function(a){this.el=a;this.$el=e(a)},resolveElement:function(a,c){var e=a;d.each(c,function(a){e=e.contents().eq(a)});return e},clear:function(){d.each(this._bindings,function(a){a.dispose()});this._bindings=[];d.each(this._triggers,function(a){a.dispose()});this._triggers=
[];d.each(this._logicBlocks,function(a){a.dispose()});this._logicBlocks=[];d.each(this._nestedTemplates,function(a){a.dispose()});this._nestedTemplates=[];this.$el.empty()},dispose:function(){this.clear()},createContext:function(a,e){var f;f=null!=e?this.options.context.clone():new c.Model;d.each(a,function(a,c,e){f.set(c,a);d.isUndefined(a)||d.isNull(a)||f.createField(c,{type:a.constructor})});return f}});g.extend(p.prototype,c.ModelNavMixins);var u=p.extend({initialize:function(){p.prototype.initialize.apply(this);
d.bindAll(this,"render")},render:function(){var a=this.options.block;this.setEl(e(a.el).clone());var c=this.createContext(this.options.context);this.renderInternal(a,this.$el,c);this.$el.removeClass("xt-template")}}),r=p.extend({initialize:function(){p.prototype.initialize.apply(this);d.bindAll(this,"modelChanged","render");var a=this.options.block.options.model;this.bindModelExpression(this.options.context,a,this.modelChanged);this.model=this.resolveModelExpressionValue(this.options.context,a)},
modelChanged:function(){var a=t.options.block.model;t.unbindModelPath(t.options.context,a,t.modelChanged);t.bindModelExpression(t.options.context,a,t.modelChanged);t.model=t.resolveModelExpressionValue(t.options.context,a)},render:function(){var a=this.options.block;this.clear();g.template(a.options.template)("destroy",this.$el);a=g.template(a.options.template)(this.model);this.$el.replaceWith(a);this.setEl(a)}}),k=p.extend({initialize:function(){var a=this,c=a.options.block;a.current=null;for(var e=
...
a.value instanceof Backbone.Collection?a.value.forEach(g):d.each(a.value,g)}d.has(c.options,"onrender")&&(g=a.resolveModelExpression(a.options.context,c.options.onrender),d.isArray(g)&&0<g.length&&(g=d.last(g),g($next)))}}),s={};c.Template=function(a,c){this.block=a;this.context=c;this.tmplID=Math.floor(1E8*Math.random());s[this.tmplID]=this};g.extend(c.Template.prototype,{render:function(){var a=new u({block:this.block,context:this.context});a.render();a=a.$el;a.data("template-id",this.tmplID);return a.children()},
dispose:function(){}});c.Template.compile=function(){var a;if(2<arguments.length)throw"Invalid arguments";a=arguments[0]instanceof e?arguments[0]:e(arguments[0]);a=e("<div></div>").append(a);var f=new m({el:a});return 2===arguments.length&&!0===arguments[1]?f:function(a,h,k){if(!d.isString(a)){k=h;var m={model:a};k&&k.context&&g.extend(m,k.context);return(new c.Template(f,m)).render()}a=arguments[0];if(!d.isString(a))throw"Invalid argument (1), String expected";switch(a){case "destroy":if(2!==arguments.length)throw"Invalid number of arguments";
m=arguments[1];if(!(m instanceof e))throw"Invalid argument (2), jQuery expected";m.data("template-id")&&s[m.data("template-id")].dispose()}}};"undefined"!==typeof test&&(c.templateInstances=s);return c});
